...
Copyright = '(c) Paul Volavsek. All rights reserved.'
...
FunctionsToExport = @('Link-Dots', 'Sync-Dots', 'Install-Dots', 'Update-Dots', 'Clone-Dots')
...
AliasesToExport = 'Link-Dot', 'Mount-Dots', 'Mount-Dot', 'Sync-Dot', 'Install-Dot', 
               'Update-Dot', 'Connect-Dots'
